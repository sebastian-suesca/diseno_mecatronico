...
-- Tiempo de generación: 24-02-2023 a las 06:58:11
...
CREATE TABLE `users` (
  ...
  `cell_phone` varchar(255) COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `cell_phone`) VALUES
(1, 'Juan leon', 'admin@admin.com', '123', '123456');
